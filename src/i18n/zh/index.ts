...
const introduction = {
    ...
    "The **Reader Guru** is a OpenAI-powered tool that integrated with OpenAI's capabilities of **summarizing** an entire book and **answering** questions based on the book.": '利用OpenAI文本总结和基于文本问答的能力。实现了对pdf或epub格式文件的总结和对话。',
